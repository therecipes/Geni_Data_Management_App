...
public class GeniLayout extends JPanel {
    ...
    public JTextField createShowUsertext;
   ...
   // public JPanel workBenchPanel;
    ...
    public void buildMenuBarLayout() {
        ...
        menu[1].getAccessibleContext().setAccessibleDescription("List of items");


        menuItem = new JMenuItem[7];
        menuItem[0] = new JMenuItem("Create Database", KeyEvent.CTRL_MASK);
        menuItem[0].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK));
        menuItem[0].getAccessibleContext().setAccessibleDescription("Items");


        menuItem[1] = new JMenuItem("Show Databases", KeyEvent.VK_A);
        menuItem[1].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK));
        menuItem[1].getAccessibleContext().setAccessibleDescription("Items");

        menuItem[2] = new JMenuItem("Use Databases", KeyEvent.VK_S);
        menuItem[2].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK));
        menuItem[2].getAccessibleContext().setAccessibleDescription("Items");

        menuItem[3] = new JMenuItem("Create Table", KeyEvent.CTRL_MASK);
        menuItem[3].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, ActionEvent.ALT_MASK));
        menuItem[3].getAccessibleContext().setAccessibleDescription("Items");
        ...
        menuItem[4].getAccessibleContext().setAccessibleDescription("Items");
        ...
        menuItem[5].getAccessibleContext().setAccessibleDescription("Items");
    ...
    public void buildTable() {
        ...
        pane.setPreferredSize(new Dimension(1280, 470));
    ...
    public void buildFilters(){
        ...
        adminLables.setFont(new Font("", Font.CENTER_BASELINE, 10));
    ...
    public void buildEditWorkBench(){
        ...
        craeteAndUpdateLable=new JLabel();
        ...
        workBenchPanel.setPreferredSize(new Dimension(1280, 200));
        frame.frame.pack();
        workBenchPanel.validate();

        add(workBenchPanel);
        //frame.frame.setSize(7100, 7600);
              //frame.frame.setExtendedState(JFrame.WIDTH);
